...
#ifndef BOLT_SOCKET_H
#define BOLT_SOCKET_H
 ...
 * \ingroup bolt
 *
 * \brief A sockets interface to BOLT
 *
 * This class provides a socket interface
 * to ns3's implementation of Bolt.
 *
 ...
 * is non-null.
 */
class BoltSocket : public Socket
{
public:
  /**
   * Get the type ID.
...
private:
  ...
  /**
   * \brief BoltSocketFactory friend class.
   * \relates BoltSocketFactory
   */
  friend class BoltSocketFactory;
  // invoked by Bolt class
